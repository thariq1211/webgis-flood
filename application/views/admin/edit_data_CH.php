    ...
    <div class="container-fluid">
      ...
      <div class="card">
        ...
        <div class="modal-body">
          <div class="container">
            <div class="card card-register mx-auto mt-1">
              ...
              <div class="card-body">
                <form class="form-material" action="<?php echo base_url('admin/atribut_ch/update') ?>" method="post">
                  <div class="form-group">
                    <div class="form-label-group">
                      <?php foreach ($ch as $value): ?>
                        <input type="hidden" name="kecamatan" value="<?php echo $value->kecamatan ?>">
                      <?php endforeach ?>
                  ...
                  <div class="form-group">
                    <div class="form-label-group">
                      <label>Input rata<sup>2</sup> CH</label>
                      <?php foreach ($ch as $value): ?>
                        <input type="number" step="any" class="form-control" name="ch" value="<?php echo $value->rata2 ?>">
                      <?php endforeach ?>
                    </select>
                  </div>
                </div>
        ...
        <div class="modal-footer">
          <a href="<?php echo base_url('admin/atribut_ch') ?>" class="btn btn-secondary">Batal</a>
