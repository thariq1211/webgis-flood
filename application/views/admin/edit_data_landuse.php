            ...
            <div class="modal-body">
              <div class="container">
                <div class="card card-register mx-auto mt-1">
                  ...
                  <div class="card-body">
                    <form class="form-material" action="<?php echo base_url('admin/atribut_landuse/update') ?>" method="post">
                      <div class="form-group">
                        <div class="form-label-group">
                        <?php foreach ($landuse as $value): ?>
                          <input type="hidden" name="landuse1" value="<?php echo $value->penggunaan_lahan ?>">
                        <?php endforeach ?>
                        <label>Input Kecamatan</label>
                          <select class="form-control" name="kecamatan">
                          <?php foreach ($landuse as $n): ?>
                      ...
                      <div class="form-group">
                        ...
                        <?php $query = $this->db->query('select * from data_penggunaan_lahan group by penggunaan_lahan order by bobot')->result();
                        foreach($query as $d){
                         ?>
                            <option value="<?php echo $d->penggunaan_lahan ?>"><?php echo $d->penggunaan_lahan ?></option>
                            <?php } ?>
                          </select>
                        </div>
                      </div>
              ...
              <div class="modal-footer">
                <a href="<?php echo base_url('admin/atribut_landuse') ?>" class="btn btn-secondary">Batal</a>
