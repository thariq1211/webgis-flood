            ...
            <div class="scroll-sidebar">
              ...
              <nav class="sidebar-nav">
                <ul id="sidebarnav">
                  ...
                  <li> <a class="waves-effect waves-dark" href="<?php echo base_url('admin/hasil_clustering')?>" aria-expanded="false"><i class="mdi mdi-chart-bubble"></i><span class="hide-menu">Hasil Analisis</span></a>
                  </li>
                  <?php } else{ ?>
